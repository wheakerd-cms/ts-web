...
<template>
	<div class="min-vw-100 min-vh-100" style="background-color: #161618">
		<div ref="divRef"
			 class="bg-opacity-10 w-75 position-fixed top-50 start-50 translate-middle py-5 px-5"
			 style="box-shadow: 0 0 150px -20px rgba(0, 0, 0, 0.5);">
		</div>
	</div>
</template>
